...
## Hints
- You can find the relevant formulae on [Wikipedia](https://en.wikipcise asks you to create more than one function so thedia.org/wiki/Conversion_of_units_of_temperature).
